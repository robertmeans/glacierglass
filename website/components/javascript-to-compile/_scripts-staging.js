...
// this is unnecessary but I'm leaving it here b/c it's useful in some instances
// I replaced "#" with "javascript:void(0)" b/c this didn't work this time.
...
$(window).resize(function() {
  var sw = document.body.clientWidth;
    if (sw < 1074 && windowState != 'small') {
       smMenu();
    }
  if (sw > 1073 && sw < 8000 && windowState != 'large') {
       lgMenu();
    }   
});
...
function smMenu() {
  ...
  $('.menuToggle').remove();
    ...
    $('.topMenu').before('<div class="menuToggle"><a href="javascript:void(0)" class="no-default">menu<span class="indicator">+</span></a></div>');
...
function lgMenu() {
  ...
  if ('ontouchstart' in document.documentElement)
    ...
    $('#main-nav').bind('touchstart', function(e){
            e.stopPropagation();
       });
  }
  //indicate current window state
